-- Coppied from the OpenOS source code
...
---@class bit32lib
---@field arshift function
---@field band function
---@field bnot function
---@field bor function
---@field btest function
---@field bxor function
---@field extract function
---@field lrotate function
---@field lshift function
---@field replace function
---@field rrotate function
---@field rshift function
